        ...
        <div class="glass-panel p-4 h-full">
            ...
            <div class="form-group">
                ...
                <div style="display: flex; gap: 15px; align-items: center; margin-bottom: 15px;">
                    <button class="qty-btn" style="width: 40px; height: 40px; font-size: 18px;" onclick="adjustTableCount(-1)"><i class="fa-solid fa-minus"></i></button>
                    <input type="number" id="setting-table-count" readonly style="width: 100px; text-align: center; font-size: 24px; font-weight: 700; background: rgba(0,0,0,0.3); border: 1px solid var(--panel-border);" value="${tables.length}">
                    <button class="qty-btn" style="width: 40px; height: 40px; font-size: 18px;" onclick="adjustTableCount(1)"><i class="fa-solid fa-plus"></i></button>
                </div>
    ...
    container.innerHTML = `
        <div class="glass-panel p-4 h-full">
            ...
            <div class="form-group" style="margin-bottom: 15px;">
                <button class="btn-primary" onclick="importItems()" style="background: var(--accent-color); padding: 12px 20px; width: 100%;">
